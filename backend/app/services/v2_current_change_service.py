...
def current_change_view(change: V2CurrentChange) -> CurrentChangeView:
    ...
    return CurrentChangeView(
        ...
        teaching_mode=change.teaching_mode,
        teaching_target=change.teaching_target,
        policy_resolved=change.policy_is_resolved,
        risk=change.risk,
        risk_reason_key=change.risk_reason_key,
        check_requirement=change.check_requirement,
        help_context_key=change.help_context_key,
        support_level_disclosed=change.support_level_disclosed,
