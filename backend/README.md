...
New assignment-bound Prompt saves carry a server-validated
...
be silently stripped. This adds no migration, provider call, task-completion
write, lifecycle authority, or semantic score.
