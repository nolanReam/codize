...
export default function ProductProof() {
  return <section id="product-proof" className={styles.proof} aria-labelledby="proof-title" data-storm-act="proof" tabIndex={-1}>
    <div className={styles.proofIntro}><h2 id="proof-title" data-storm-enter>Your project.<br />Your thinking.<br /><em>A little backup.</em></h2><p data-storm-enter="after">Keep your coding AI. Codize helps you focus on the next feature, prompt clearly, check what happened, and understand the result.</p></div>
